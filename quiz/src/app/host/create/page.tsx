  ...
  const createGame = async () => {
    ...
    try {
      ...
      const questions = [
        ...
        {
          quiz_id: quiz.id,
          question_text: "Q.11 Which garrison city (Misr) did Hazrat Umar RZ found in Iraq?\nحضرت عمر رضی اللہ عنہ نے عراق میں کون سا فوجی شہر بسایا؟\nहज़रत उमर रज़ि. ने इराक़ में कौन-सा फ़ौजी शहर بसाया?",
        ...
        {
          quiz_id: quiz.id,
          question_text: "Q.15 Which department did Hazrat Umar RZ establish to register and pay soldiers?\nحضرت عمر رضی اللہ عنہ نے فوجیوں کو رجسٹر کرنے اور تنخواہ دینے کے لیے کون سا شعبہ قائم کیا؟\nहज़रत उमर रज़ि. ने फ़ौजियों को रजिस्टर करने और तनख़्वाह देने के लिए कौन-सा शोबा क़ायम किया?",
        ...
        {
          quiz_id: quiz.id,
          question_text: "Q.18 In which mosque was Hazrat Umar RZ attacked during Fajr prayer?\nحضرت عمر رضی اللہ عنہ پر نماز فجر کے دوران کس مسجد میں حملہ ہوا؟\nहज़रत उमर रज़ि. पर नमाज़ फ़जर के दौरान किस मस्जिद में हमला हुआ?",
        ...
        {
          quiz_id: quiz.id,
          question_text: "Q.20 How many members were in the Shura (committee) Hazrat Umar RZ appointed to select the next Caliph?\nحضرت عمر رضی اللہ عنہ نے اگلے خلیفہ کے انتخاب کے لیے کتنے افراد کی شوریٰ مقرر کی؟\nहज़रत उमر रज़ि. ने अगले खलीफ़ा के चुनाव के लिए कितने सदस्यों की शूरा मुकर्रर की?",
